    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple2<Long, Integer>> withTimestamps = input
                .assignTimestampsAndWatermarks(
                        WatermarkStrategy.<Tuple2<Long, Integer>>forBoundedOutOfOrderness(Duration.ofSeconds(2))
                                .withTimestampAssigner((element, recordTimestamp) -> element.f0)
                );

        // Sliding window: size = 10 seconds, slide = 5 seconds
        ...
        env.execute("Sliding Event Time Window Average");
    }
